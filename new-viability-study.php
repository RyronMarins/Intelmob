...
<html
   ...
   <head>
         ...
         ?>
      <!--<script>
         // Esta parte é equivalente à lógica de redirecionamento no PHP
         // Vamos supor que você tenha uma função "isUserLoggedIn()" que verifica se o usuário está logado
         // Você precisará criar essa função e adaptá-la ao seu sistema de autenticação
         function isUserLoggedIn() {
            // Implemente a lógica aqui para verificar se o usuário está logado
            // Por exemplo, você pode usar cookies, LocalStorage, ou uma chamada AJAX para verificar com o servidor.
            // Retorne true se o usuário estiver logado, caso contrário, retorne false.
            // Verifique o arquivo //assets/js/pages-auth.js para um template já funcional
            // Exemplo simples:
            // return localStorage.getItem('loggedIn') === 'true';
         }

         // Verifica se o usuário já está logado e redireciona para a página inicial
         if (isUserLoggedIn()) {
            // Recupera as informações do usuário logado
            const email = 'ryronmarins@gmail.com';
            const encodedEmail = JSON.stringify(email); // No JavaScript, não é necessário escapar caracteres como no PHP
            console.log(encodedEmail);
         }// else {
            // Redireciona para a página inicial (auth-login.html, por exemplo)
            // Implemente o redirecionamento aqui, dependendo de como seu sistema funciona.
            // Por exemplo, use window.location.href = 'auth-login.html';
            // ou use uma biblioteca para roteamento, como React Router ou Vue Router.
         //}
      </script>-->
   </head>
                                 ...
                                 <div class="row p-0 p-sm-4">
                                    <div class="card mb-4">
                                       ...
                                       <div class="card-body">
                                          ...
                                          <div class="mb-3 row">
                                             <label for="html5-data4-input" class="col-md-3 col-form-label">Área Privativa Total (em m2)</label>
                                             <div class="col-md-9">
                                          ...
                                          <div class="col-12">
                                             <script>
                                                ...
                                                function registrarSolicitacao() {
                                                   var email = 'ryronmarins@gmail.com';
                                                   console.log('Função registrarSolicitacao chamada.');   
                                                   // Obter os valores dos campos do formulário
                                                   var areaTotal = document.getElementById('html5-data1-input').value;
                                                   var precoTerreno = document.getElementById('html5-data2-input').value;
                                                   var custoConstrucao = document.getElementById('html5-data22-input').value;
                                                   var precoMedio = document.getElementById('html5-data3-input').value;
                                                   var areaConstruida = document.getElementById('html5-data7-input').value;
                                                   var areaPrivativa = document.getElementById('html5-data4-input').value;
                                                   var precoMedioSugerido = document.getElementById('html5-data5-input').value;
                                                   var quantidadeUnidades = document.getElementById('html5-data6-input').value;
                                                   var enderecoCompleto = document.getElementById('Textarea1').value;
                                                   var tipo = document.getElementById('select2Basic').value;
                                                   var haPermutaFisica = document.getElementById('inlineCheckbox1').checked;
                                                   var haPermutaFinanceira = document.getElementById('inlineCheckbox2').checked;

                                                   // Criar objeto JSON com os dados do formulário
                                                   var formData = {
                                                      email: email,
                                                      areaTotal: areaTotal,
                                                      precoTerreno: precoTerreno,
                                                      custoConstrucao: custoConstrucao,
                                                      precoMedio: precoMedio,
                                                      areaConstruida: areaConstruida,
                                                      areaPrivativa: areaPrivativa,
                                                      precoMedioSugerido: precoMedioSugerido,
                                                      quantidadeUnidades: quantidadeUnidades,
                                                      enderecoCompleto: enderecoCompleto,
                                                      tipo: tipo,
                                                      haPermutaFisica: haPermutaFisica,
                                                      haPermutaFinanceira: haPermutaFinanceira
                                                };
